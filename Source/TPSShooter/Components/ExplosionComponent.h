...
class TPSSHOOTER_API UExplosionComponent : public USceneComponent
{
	GENERATED_BODY()
...
protected:
	...
	UParticleSystem* ExplosionVFX; // Asd in our case we have no Niagara PS we use Cascade (UParticleSystem)
};
